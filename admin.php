...
<html lang="fr">
   ...
   <body>
    ...
    <?php include("lqnavbar.php"); ?>
      <section>
         <div class="container">
         <h3 style="text-align: center; margin-bottom: 2rem;"> Delete the unwanted questions!</h3>
         <?php
         ...
         foreach (array_reverse($results) as $result) {
            ...
            echo "<div class='toast show' role='alert' aria-live='assertive' aria-atomic='true'>",
                 ...
                 "<strong class='mr-auto'><img class='avatar' src='" . getAvatar($result[3]) . "'> <a href='profil.php?pseudo_id=$result[3]'>" . getAuteur($result[3]) . "</a> | $responseNumber[0] reply | " . getCateg($result[2]) . " | <a href='like.php?question_id=$result[0]'><i class='$likeIcon'></i></a> $likesNumber</strong>
                 <small>$result[4]</small>",
                 "<a href='delete.php?question_id=$result[0]'><button class='' style='    background: #fdc500;' type='button'>
                 DELETE</button></a>",
                 "</div>",
